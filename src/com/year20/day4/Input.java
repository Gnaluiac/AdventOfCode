...
public class Input {
    ...
    private static String[] getIndividualPassports() {
        return input.split("\n\n");
    }

    public static List<String[]> getListSplitPassports() {
        List<String[]> passports = new ArrayList<>();
        String[] rawPassports = getIndividualPassports();

        for (String passport:rawPassports) {
            String[] cleanedPassport = passport.split(" |\\\n");
            passports.add(cleanedPassport);
        }
        return passports;
    }
}
